  ...
  <div class="row">
    <div class="col-12 col-6-tablet push-3-tablet col-4-desktop push-4-desktop">
      <form class="form">
        ...
        <fieldset>
        <input class="block" type="file" name="avatar" placeholder="add avatar image">
      </fieldset>
...
const addUser = user => {
  ...
  if(userList) {
    ...
    userList.innerHTML += `<li>
      <a class="block relative" href="${user.avatar}">
...
const getCredentials = () => {
  const user = {
    ...
    avatar :document.querySelector('[name="avatar"]').file
  };
